...
System::Void matlab::GraphIntegr::Расчёт(System::Object^ sender, System::EventArgs^ e, double a, double b, double tay, String ^ function, String ^ integral, int method) {
	//double a, b;
	//double tay;
	int type;
	//int method;
	...
	type = 8;
	Integral::Function fun(type, a, b, funcLine, integrLine);
