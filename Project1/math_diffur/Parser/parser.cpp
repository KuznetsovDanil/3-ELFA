...
long double parser::PARS(const std::string inLine,const long double x, const long double  y)
{
    std::string outLine;
...
long double parser::pars(char* argv) {

    std::stack<long double> s;  std::stack< std::pair<int, char> > ops;
